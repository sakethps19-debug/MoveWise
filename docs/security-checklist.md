...
| Rate limiting | **Not implemented.** `loginAction`/`signupAction` have no attempt throttling — a real risk for credential stuffing at any real traffic level. Flagged in `docs/known-risks.md`. |
